...
public class LibraryUserJwtAuthenticationConverter implements Converter<Jwt, Mono<AbstractAuthenticationToken>> {
    ...
    public LibraryUserJwtAuthenticationConverter(LibraryReactiveUserDetailsService libraryReactiveUserDetailsService) {
    ...
    public Mono<AbstractAuthenticationToken> convert(Jwt jwt) {
        ...
        return libraryReactiveUserDetailsService
                ...
                .map(userDetails -> new UsernamePasswordAuthenticationToken(userDetails, "n/a", authorities));
    }
    ...
    private Collection<String> getScopes(Jwt jwt) {
        ...
        if (scopes instanceof Collections) {
